...
class FSRedAgentTargetAOperational(FiniteStateRedAgent):
    ...
    def __init__(self, name=None, np_random=None, agent_subnets=None):
        ...
        self.zone_a_keywords = ['operational_zone_a']
    ...
    def _choose_host(self, host_options: List[str]):
        ...
        if self.host_states_priority_list is None:
            ...
            for h_opt in host_options:
                ...
                if self._is_zone_a(hostname) and state in ('RD'):
                    weight = 2
            ...
            print("Prioritizing A Is not implemented here")
            base = 100
            available_states = {}
